		...
		if ( is_music ) {
			...
			while(tok != 0) {
				...
				switch(tok) {
					...
					case 43 : { // prima volta. Add as local comment to next note.
						(relLyTokens.back()).push_back(RelLyToken("^\"Start of prima volta\"", getLocation(), WCELineNumber, pos_in_line, RelLyToken::FREETEXT, is_music));
					} break;
					case 44 : { // secunda volta. Add as local comment to next note.
						(relLyTokens.back()).push_back(RelLyToken("^\"Start of secunda volta\"", getLocation(), WCELineNumber, pos_in_line, RelLyToken::FREETEXT, is_music));
					} break;
					case 45 : { // tertia volta. Add as local comment to next note.
						(relLyTokens.back()).push_back(RelLyToken("^\"Start of tertia volta\"", getLocation(), WCELineNumber, pos_in_line, RelLyToken::FREETEXT, is_music));
					} break;
					case 46 : { // quarta volta. Add as local comment to next note.
						(relLyTokens.back()).push_back(RelLyToken("^\"Start of quarta volta\"", getLocation(), WCELineNumber, pos_in_line, RelLyToken::FREETEXT, is_music));
					} break;
					case 47 : { // end volta. Add as local comment to next note.
